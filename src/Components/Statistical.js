          ...
          <div class="body__right-orderDetail">
            ...
            <div class="right__orderDetail-footer row">
              <div class="orderDetail__item col-lg-3 col-md-3 col-sm-6">
                ...
                style="background-image: url('./images/image-product-sale/iphone-12-green.webp');
                background-position: center;
                background-repeat: no-repeat;
          ...
          col-lg-3 col-md-3 col-sm-6">
            ...
            <div class="row">
              <div class="col-lg-2 col-md-2 col-sm-2">
                <div style="background-image: url('./images/image__footer-content/face.png');
                background-position: center;
                background-repeat: no-repeat;
                background-size: contain;"></div>
              </div>
              <div class="col-lg-2 col-md-2 col-sm-2">
                <div style="background-image: url('./images/image__footer-content/zalo.png');
                background-position: center;
                background-repeat: no-repeat;
                background-size: contain;"></div>
              </div>
              <div class="col-lg-2 col-md-2 col-sm-2">
                <div style="background-image: url('./images/image__footer-content/instar.png');
                background-position: center;
                background-repeat: no-repeat;
                background-size: contain;"></div>
              </div>
