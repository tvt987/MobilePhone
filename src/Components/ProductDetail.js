        ...
        <div class="container mt-sm-2 mt-md-5 mb-sm-2 mb-md-5">
            <div class="product-detail">
                    ...
                    <div id="custCarousel" class="carousel slide" data-ride="carousel" align="center">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="/images/img-iphone/iphone-15-pro-max-blue-titan-5-650x650.webp" alt="Hills">
                        </div>
              
                        <div class="carousel-item">
                          <img src="/images/img-iphone/iphone-11-white-thumbtz-650x650.webp"  alt="Hills">
                        </div>
              
                        <div class="carousel-item">
                          <img src="/images/img-iphone/iphone-13-blue-thumbtz-650x650.webp"  alt="Hills">
                        </div>
              
                        <div class="carousel-item">
                          <img src="/images/img-iphone/iphone-14-pro-max-purple-thumbtz-650x650.webp"     alt="Hills">
                        </div>
                      </div>
                      ...
                      <ol class="carousel-indicators list-inline">
                        <li class="list-inline-item active">
                          <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#custCarousel">
                            <img src="/images/img-iphone/iphone-15-pro-max-blue-titan-5-650x650.webp"  class="img-fluid">
                          </a>
                        </li>
              
                        <li class="list-inline-item">
                          <a id="carousel-selector-1" data-slide-to="1" data-target="#custCarousel">
                            <img src="/images/img-iphone/iphone-11-white-thumbtz-650x650.webp"  class="img-fluid">
                          </a>
                        </li>
              
                        <li class="list-inline-item">
                          <a id="carousel-selector-2" data-slide-to="2" data-target="#custCarousel">
                            <img src="/images/img-iphone/iphone-13-blue-thumbtz-650x650.webp"   class="img-fluid">
                          </a>
                        </li>            
                         <li class="list-inline-item">
                          <a id="carousel-selector-2" data-slide-to="3" data-target="#custCarousel">
                            <img src="/images/img-iphone/iphone-14-pro-max-purple-thumbtz-650x650.webp"   class="img-fluid">
                          </a>
                        </li>
                       </ol>
                    </div>
              ...
              <div class="product-info ml-md-4">
                  ...
                  <img class="img-dis" src="/images/image-sale/Frame-482029--1--920x230.png" alt="">  
