    ...
    <div>
      <div className="model-login">
        <div className="model-form">
          <div className="model-form__header">Login</div>
          ...
          <div className="model-form__body">
            ...
            <div className="model-body__remember">
              <div className="model-body__remember-wrap">
                <div className="model-body__rememberMe">Remember Me?</div>
                <div className="model-body__forgotPass js-model-forget">
                  Forgot Password?
                </div>
              </div>
              <button onClick={() => alert("a")} className="model__btn-login">
                Login
      ...
      <div className="model-register">
        <div className="model-form">
          <div className="model-form__header">Sign up</div>
      ...
      <div className="model-forget">
        <div className="model-form">
          <div className="model-form__header">Forget Password</div>
          ...
          <div className="model-form__body">
            <div className="model-body__ipts">
              ...
              <div className="model-body__ipt-wrap">
                ...
                />
                <button className="model-body__ipt-capcha">Gửi mã</button>
              </div>
              <div className="model-body__ipt-wrap">
                <input
                  type="text"
          ...
          <div className="model-form__footer">
            <button className="model-form__btn">Change</button>
            <div className="model-form__backlogin js-model-login">Login</div>
          </div>
        </div>
      </div>
      ...
      <div className="model-changepass">
        <div className="model-form">
          <div className="model-form__header">Change Password</div>
          ...
          <div className="model-form__body">
            ...
            <div className="model-body__ipts">
              ...
              <div className="model-body__ipt-wrap">
                <input
                  type="date"
                  className="model-body__ipt model-body__ipt--birthday"
