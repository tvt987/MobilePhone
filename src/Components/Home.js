...
import iconIphone11Sale from '../static/images/image-product-sale/iphone-11-sale.webp'
        ...
        <div className="container-sale mt-2 mb-2">
            ...
            <div id="slider">
                ...
                <div className="product-sale">
                    ...
                    <div className="product-item">
                        <img src={iconIphone11Sale}/>
                        <p className="name-sale">Iphone 11 64GB</p>
                        <div className="price">
                            <p className="price-new">10.190.000₫</p>
                            <p className="price-old">11.590.000₫</p>
                        </div>
                        <div className="count-product">
                            <img src={iconFsIconFire} />
                            <i>10/10</i>
            ...
            <div className="container-watch mt-2 mb-2">
                ...
                <div id="slider-watch">
                    ...
                    <div className="product-watch">
                        ...
                        <div className="product-item">
                            <img src="/images/img-watch/apple-watch-se-2022-gps-40mm-thumbtz-2-650x650.webp"/>
                            <p className="name-product">AW Series 8 GPS 45mm</p>
                            <div className="price">
                                <p className="price-new">10.190.000₫</p>
                                <p className="price-old">12.990.000₫ <span className="discount">-21%</span></p>
            ...
            <div className="container-at mt-2 mb-2">
                ...
                <div id="slider-at">
                    ...
                    <div className="product-at">
                        <div className="product-item">
                            <img src="/images/img-amthanh/airpods-max-select-hong-thumb-10-650x650.webp"/>
                        ...
                        <div className="product-item">
                            <img src="/images/img-amthanh/beats-studio-buds-trang-thumb-650x650.webp"/>
                        ...
                        <div className="product-item">
                            <img
                                src="/images/img-amthanh/bluetooth-airpods-pro-magsafe-charge-apple-mlwk3-tkm-650x650.webp"/>
    ...
    <div className="model-form">
      ...
      <div className="model-form__footer">
        <div className="model-footer__login">
          <div>
          <span>With</span>
            <img src="./images/img-model/logo-google.png" alt=""/>
          <span>Or</span>
            <img src="./images/img-model/logo-face.png" alt=""/>
        </div>
    ...
    <div className="model-form">
      ...
      <div className="model-form__footer">
        <div className="model-footer__login">
          <div>
          <span>With</span>
            <img width="3%" src="./images/img-model/logo-google.png" alt=""/>
          <span>Or</span>
            <img width="3%" src="./images/img-model/logo-face.png" alt=""/>
        </div>
        <div className="model-footer__regiter">
    ...
    <div className="model-form">
      ...
      <div className="model-form__body">
        <div className="model-body__avt-wrap">
          ...
          style={{backgroundImage: `url(${logoProfile})`,
